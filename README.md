...
RUN set -x \
  ...
  && cd /tmp \
  && wget -nv https://github.com/panubo/bash-container/releases/download/v0.1.1/panubo-functions.tar.gz \
  && wget -nv https://github.com/panubo/bash-container/releases/download/v0.1.1/panubo-functions.tar.gz.asc \
